    ...
    <div className="min-h-screen bg-slate-50 dark:bg-[#050505] flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 text-slate-900 dark:text-white transition-colors duration-300 relative">
      ...
      <div className="max-w-4xl mx-auto w-full">
        <div className="bg-white dark:bg-[#0F0F0F] rounded-3xl border border-slate-200 dark:border-[#262626] overflow-hidden grid grid-cols-1 md:grid-cols-2 shadow-2xl">
          {/* Left Column: Real Travel Image & Brand Proposition */}
          <div className="relative min-h-[300px] md:min-h-[500px] p-8 md:p-12 flex flex-col justify-between overflow-hidden bg-slate-900 text-white">
            ...
            <div className="relative z-10">
              ...
              <p className="mt-3 text-white/80 text-xs leading-relaxed">
                Unlock tailor-made itineraries, curated stays, and authentic local culinary insights across India.
              </p>
            </div>
          ...
          {/* Right Column: Dark/Light Login Form */}
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  <label className="block text-[10px] font-bold text-slate-600 dark:text-[#9CA3AF] uppercase tracking-wider">
                    Password
                  </label>
                  <button
                    type="button"
              ...
              <button
                ...
                className="w-full py-2.5 px-4 bg-slate-100 dark:bg-[#141414] hover:bg-slate-200 dark:hover:bg-[#1a1a1a] text-slate-700 dark:text-[#9CA3AF] hover:text-slate-950 dark:hover:text-white border border-slate-200 dark:border-[#262626] text-xs font-semibold rounded-xl transition-all duration-200 cursor-pointer"
              >
                Quick Demo Login ⚡
              </button>
            </form>

            <div className="mt-8 pt-6 border-t border-slate-100 dark:border-[#1F1F1F] text-center text-xs text-slate-500 dark:text-[#9CA3AF]">
